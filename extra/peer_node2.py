...
if __name__ == "__main__":
    ...
    node_id = "NodeB"   # Identificador único para este nodo
    node_port = 8002    # Puerto único para este nodo
    shared_files = ["file3.txt", "file4.mp4", "file_large.mp4"]  # Archivos compartidos por este nodo
